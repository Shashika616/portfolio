...
export default function ProfileHeader() {
  ...
  return (
    <div className="relative p-[2px] rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(37,99,235,0.08)] w-full max-w-[340px] sm:max-w-md group">
      ...
      {/* INNER SOLID BODY */}
      <div className="relative flex items-center gap-3 sm:gap-4 select-none bg-gradient-to-r from-slate-50 via-white to-slate-50 px-4 sm:px-6 py-3 rounded-[14px] w-full h-full z-10">
        ...
        <div className="flex flex-col min-w-0 flex-1">
          ...
          <span className="font-mono text-[11px] sm:text-xs text-slate-400 mt-0.5 whitespace-nowrap"><strong>Software Engineer</strong></span>
          <div className="flex items-center gap-1.5 mt-1">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="font-mono text-[8px] sm:text-[9px] text-slate-500 font-bold uppercase whitespace-nowrap">STATUS: ACTIVE</span>
          </div>
        </div>
      </div>
    </div>
