...
export default function ThemeSelector() {
  ...
  // Close automatically if the user clicks completely outside the system
  useEffect(() => {
  ...
  return (
    <div ref={menuRef} className="fixed bottom-6 left-6 z-[9999]">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-900 text-white rounded-full shadow-xl hover:bg-slate-800 transition-all border border-slate-700 font-mono text-xs font-bold"
      >
      ...
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-3 w-64 bg-white/90 backdrop-blur-lg border border-slate-200/80 shadow-2xl rounded-2xl p-2 animate-in fade-in slide-in-from-bottom-3 duration-200">
